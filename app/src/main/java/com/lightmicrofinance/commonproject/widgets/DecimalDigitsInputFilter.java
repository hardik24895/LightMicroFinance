package com.lightmicrofinance.commonproject.widgets;
...
public class DecimalDigitsInputFilter implements InputFilter {
    ...
    public DecimalDigitsInputFilter(int maxDigitsBeforeDot, int maxDigitsAfterDot) {
